...
<body>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navcol-1">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="cartDetails.jsp"
					id="mycart"><span class="fa-sharp fa-solid fa-cart-shopping"></span>&nbsp;cart
				</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="cartDetails.jsp"
					id="mycart"><i class="fa fa-shopping-cart" aria-hidden="true"></i><i
						data-count="<%=notf %>" class="badge" aria-hidden="true"> </i></a></li>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="userHome.jsp">Mobiles</a><a
							class="dropdown-item" href="userHome.jsp">tv's</a><a
							class="dropdown-item" href="userHome.jsp">Laptops</a>
					</div></li>
				<li class="nav-item"><a class="nav-link"
					href="userWishList.jsp">Wish List</a></li>
	...
	<div
		...
		<p align="center"
			style="color: blue; font-weight: bold; margin-top: 15px;"
			id="message"></p>
	</div>
