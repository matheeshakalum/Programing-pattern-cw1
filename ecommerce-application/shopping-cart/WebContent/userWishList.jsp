  	...
  	%>
			...
			<div class="col mb-1">
				<div class="card">
					...
					<div class="card-body">
						<h4 class="card-title"><%=product.getProdName() %>
						</h4>
						...
						<form method="post">
							<div class="btn-group btn-group-sm" role="group">
								...
								<a class="btn btn-dark btn-sm" role="button" href="#"
									style="font-size: 12px; margin-right: 5px;">check out</a> <a
									href="./AddtoWishList?uid=<%=userName %>&pid=<%=product.getProdId()%>&type=removeFromList"><i
