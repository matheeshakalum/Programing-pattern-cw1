                ...
                <div class="col mb-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post">
                                <div class="btn-group btn-group-sm" role="group"><button class="btn btn-success" type="submit" formaction="<%= addToCartUrl%>" style="font-size: 12px;margin-right: 5px;">add to cart</button><a class="btn btn-dark btn-sm" role="button" href="#" style="font-size: 12px;">check out</a></div>
                            </form>
                        </div>
                    </div>
                </div>
