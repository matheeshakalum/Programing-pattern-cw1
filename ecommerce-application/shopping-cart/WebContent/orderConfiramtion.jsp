...
%>
					...
					<tr>
						...
						<td><input class="form-control" type="number" name="pqty"
							value="<%= prodQuantity %>" style="max-width: 70px;" min="0"
							readonly=""></td>
						<td><%=currAmount %></td>
					</tr>
					<tr></tr>
			...
			<div class="col">
				<form>
					...
					<div class="form-row row-cols-1 row-cols-sm-2 py-1">
						<div class="col">
							<label class="col-form-label">Rs : 100 charge for change
								the delivery address</label>
						</div>
						<div class="col">
							<input type="checkbox" name="checkAddress" id="chkAddress"
								onclick="EnableDisableTextBox(this)" value="addressNew"><label>&nbsp;
								add different shipping address</label>
						</div>
					</div>
					<div class="form-row row-cols-1 row-cols-sm-2 py-1">
						<div class="col">
							<label class="col-form-label">Shipping Address&nbsp;
								&nbsp; &nbsp;:</label>
						</div>
						<div class="col">
							<textarea class="form-control" name="txtaddress" rows="5"
								id="txtAddress"><%=userAddress %></textarea>
						</div>
					</div>
					<div class="form-row row-cols-1 row-cols-sm-2 py-1">
						<div class="col">
							<label class="col-form-label">Product Amount to Pay :</label>
						</div>
						<div class="col">
							<input class="form-control" id="productAmount" type="text"
								value="<%=totAmount %>" style="text-align: right;" name="amount"
								readonly="">
						</div>
					</div>
					<div class="form-row row-cols-1 row-cols-sm-2 py-1">
						...
						<div class="col">
							<input class="form-control" id="deleveryCharge" type="text"
								value="0" style="text-align: right;" name="amount" readonly="">
						</div>
					</div>
					<div class="form-row row-cols-1 row-cols-sm-2 py-1">
						<div class="col">
						...
						<div class="col">
							<input class="form-control" type="text" id="totalAmount"
								value="0" style="text-align: right;" name="Totalamount"
								readonly="">
						</div>
					</div>
					<div class="form-row row-cols-1 row-cols-sm-2 py-3">
						<div class="col mb-2">
							<a href=cartDetails.jsp><button
									class="btn btn-warning btn-sm" type="button">back to
									cart</button></a>
						</div>
						<div class="col mb-2">
							<form method="post">
								<button class="btn btn-success btn-sm"
									formaction="payment.jsp?amount=<%=totAmount %>?txtaddress=<%=userAddress%>">pay
									now</button>
							</form>
						</div>
					</div>
