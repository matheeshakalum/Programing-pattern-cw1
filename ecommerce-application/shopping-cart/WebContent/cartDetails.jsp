...
%>
					...
					<tr>
						...
						<td><a
							href="cartDetails.jsp?add=1&uid=<%=userName %>&pid=<%= product.getProdId()%>"><i
								class="fa fa-plus"
								style="background-color: transparent !important"></i></a></td>
						<td><a
							href="cartDetails.jsp?add=0&uid=<%=userName %>&pid=<%= product.getProdId()%>"><i
								class="fa fa-minus"
								style="background-color: transparent !important"></i></a>
						<td><%=currAmount %></td>
					</tr>
					<tr></tr>
  ...
  %>
					...
					<tr>
						...
						<td><form method="post">
								<button formaction="userHome.jsp" class="btn btn-dark">Keep
									Shopping</button>
							</form></td>
						<td colspan="2" align="center"><form method="post">
								<button class="btn btn-success"
									formaction="orderConfiramtion.jsp">Confirm Order</button>
							</form></td>
