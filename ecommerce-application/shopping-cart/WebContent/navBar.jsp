...
<!-- End of Navigation Bar -->
 ...
 <nav class="navbar navbar-light navbar-expand-lg fixed-top navigation-clean">
        <div class="container"><a class="navbar-brand" href="index.jsp" style="font-size: 15px;letter-spacing: 2px;">Digital Vision</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="loginFirst.jsp"><span class="fa-sharp fa-solid fa-cart-shopping"></span>&nbsp;cart </a></li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#">products</a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="index.jsp">Mobiles</a><a class="dropdown-item" href="index.jsp">tv's</a><a class="dropdown-item" href="index.jsp">Laptops</a></div>
                    </li>
