						...
						<form method="post">
							<div class="btn-group btn-group-sm" role="group">
								...
								<a class="btn btn-dark btn-sm" role="button" href="#"
									style="font-size: 12px; margin-right: 5px;">check out</a>
								<%if(isWishListAdded==true){%>
								<a
									href="./AddtoWishList?uid=<%=userName %>&pid=<%=product.getProdId()%>&type=remove"><i
									class="fa fa-heart fa-heart fa-2x" style="cursor: pointer;"></i></a>
								<%}else{%>
								<a
									href="./AddtoWishList?uid=<%=userName %>&pid=<%=product.getProdId()%>&type=add"><i
									class="fa-regular fa-heart fa-2x" style="cursor: pointer;"></i></a>
								<%} %>
							</div>
						</form>
					</div>
